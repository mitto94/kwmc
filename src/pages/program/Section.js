    ...
    <div style={{width: "100%",  display: "flex", flexDirection: "column", background: "#ECF6FC"}}>
        ...
        <div className="mMargin0" style={{width: "100%", display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center", marginTop: ".8vw", fontFamily: "Noto Sans KR, sans-serif"}}>
          ...
          {section === "선교협력" && <div className="mWidth100 mFlexContainer mContainer4p" style={{width: "60%", display: "flex", padding: "2.5vw", border: "1px solid rgb(226, 226, 226)", fontSize: "1vw", marginBottom: "3.5vw", background: "white", flexDirection: "column"}}>
            ...
            <span>
              한국 교회와 선교사를 섬기는 선교협의회 3 단체가 있다. KWMC(Korean World Mission Council), KWMA(The Korea World Missions Association), KWMF(Korea World Missionary Fellowship) 이다. 이들 단체들은 대상을 한국인으로 사역을 한정하나 성격은 차별적이다. 예를 들면 KWMC는 미국의 한인 교회 동원을 위해서 만들어진 단체이고 미주 한인 교회의 선교 동원의 다이내믹을 만들어내기 위해 선교현장의 선교사들과 더불어 사역을 해 왔다. KWMA 는 국내에 있는 교회와 선교단체를 격려하여 선교적 협력과 동원을 위해 만들어진 단체이다. KWMF 는 전에는 타문화권 선교를 강조하기 위해 세상(World)를 첫 글자로 사용하여 WKMF (World Korea Mission Fellowship) 라 이름 했으나, 후에 다른 2 단체와의 협력을 위해 한국인의 정체성인 Korea를 먼저 사용하여 KWMF(Korea World Missions Fellowship)로 변경하였다. 이후 3 단체의 리더들은 원탁회의(Round table)를 하와이, 이집트. 이스라엘 등에서 가졌으며 선교적 협력과 유대를 강화하였다.  
              <br></br><br></br>
              이 강의는 이상의 3단체가 이상적인 사역을 하기 위해서 고유의 사역과 더불어 협력을 어떻게 해야 하는지를 제안하는 내용이다. 
              <br></br><br></br>
              가. KWMC 의 사역의 특성 <br></br>

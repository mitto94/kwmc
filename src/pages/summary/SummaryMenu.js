  ...
  return (
    <div className="mWidth100 mMenuTextSize mdLRBorder" style={{width: "60%", height: "9vh", minHeight: "20px", border: "1px solid #E2E2E2", display: "flex", justifyContent: "space-around", alignItems: "center", background: "#F3F3F3", color: "#807F7F", cursor: "pointer", fontWeight: 500, fontSize: "1.3vw", borderTop: "none"}}>
            <div className={history?.location.pathname === "/summary" ? "clickedMenu" : ""} onClick={() => {history.push({
              ...
              style={{borderRight: "1px solid #E2E2E2", width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center", background: "white", textAlign: "center", wordBreak: "keep-all"}}>인사말 (Invitation)</div>
            <div className={history?.location.pathname === "/summary_character" ? "clickedMenu" : ""} onClick={() => {history.push({
              ...
              style={{borderRight: "1px solid #E2E2E2", width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center", background: "white", textAlign: "center", wordBreak: "keep-all"}}>대회소개 (Invitation)</div>
            <div className={history?.location.pathname === "/summary_organization" ? "clickedMenu" : ""} onClick={() => {history.push({
              ...
              style={{borderRight: "1px solid #E2E2E2", width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center", background: "white", textAlign: "center", wordBreak: "keep-all"}}>제9차 KWMC 공동대회장 (The 9th KWMC Co-chairs)</div>
            <div className={history?.location.pathname === "/summary_KWMC" ? "clickedMenu" : ""} onClick={() => {history.push({
              pathname: "/summary_KWMC",
              state: {
                from: "summary"
              }
              })}} style={{width: "100%", display: "flex", justifyContent: "center", alignItems: "center", height: "100%", background: "white", textAlign: "center", wordBreak: "keep-all"}}>KWMC 소개 (About KWMC)</div>
          </div>
  );
}

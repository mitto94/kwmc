              ...
              <div className="mTextSize notosanskr" style={{margin: "2rem", lineHeight: "150%", background: "white", fontWeight: "400"}}>
                ...
                <span>
                  ...
                  <br></br><br></br>
                    ...
                    <br></br><br></br>
                    a.    디아스포라 현상에서 나타난 제자삼기, 도시선교에서 나타나는 제자삼기, 문화예술&미디어 선교를 통해서 제자삼기, 교육선교를 통한 제자삼기, 비정부기구(국제기구)를 통한 제자삼기, BAM을 통한 제자삼기, 선교동원을 통한 제자삼기, 선교적 교회를 통한 제자삼기, 전방개척사역을 통한 제자삼기, 선교적 공동체성경읽기를 통한 제자삼기, 선교협력을 통한 제자삼기, MK(선교사자녀)사역을 통한 제자삼기의 분야에서 각 트랙은 약 3개 이상의 워크숍으로 나뉩니다. 
                    <br></br><br></br>
